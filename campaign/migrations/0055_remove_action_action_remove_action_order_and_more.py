...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='action',
            name='duration',
            field=models.CharField(blank=True, choices=[('minutes', 'minutes'), ('hours', 'hours'), ('days', 'days')], max_length=50, null=True),
        ),
        migrations.AddField(
            model_name='action',
            name='number',
        ...
        migrations.AlterField(
            model_name='campaign',
            name='date_created',
            field=models.DateTimeField(default=datetime.datetime(2022, 10, 17, 11, 18, 21, 850421)),
        ),
    ]
