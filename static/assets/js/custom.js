...
$(document).ready(function () {
  $("#admin_dashboard_table").dataTable({
    language: {
      ...
      paginate: {
        next: '<img src="/static/assets/images/icons/chevron_right.svg" alt="image">',
        previous:
          '<img src="/static/assets/images/icons/chevron_left.svg" alt="image">',
      },
    },
    bPaginate: true,
    bLengthChange: false,
...
$("#trigger_next").on("click",function (e){
  ...
  if (document.getElementById('Keywords').checked){ 
    $("#Trigger ").modal("hide");
    $("#keyword_trigger ").modal("show");
  }
  else if (document.getElementById('data_based').checked){
    $("#Trigger ").modal("hide");
    $("#data_based_trigger ").modal("show");
  }
